document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchData() {
        const res = await fetch('https://689a18d1fed141b96ba1debf.mockapi.io/JustDoIt/JustDoIt', {
            method: 'GET',
            headers: {
    ...
    async function addNewTask() {
        ...
        console.log(task);
        if (task.trim() === '') return;
        await fetch('https://689a18d1fed141b96ba1debf.mockapi.io/JustDoIt/JustDoIt', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
